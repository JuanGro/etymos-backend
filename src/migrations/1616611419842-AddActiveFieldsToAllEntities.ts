...
implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'ALTER TABLE "reference" ADD "active" boolean NOT NULL DEFAULT true',
    );
    await queryRunner.query(
      'ALTER TABLE "option" ADD "active" boolean NOT NULL DEFAULT true',
    );
    await queryRunner.query(
      'ALTER TABLE "question" ADD "active" boolean NOT NULL DEFAULT true',
    );
    await queryRunner.query(
      'ALTER TABLE "test" ADD "active" boolean NOT NULL DEFAULT true',
    );
    await queryRunner.query(
      'ALTER TABLE "pattern" ADD "active" boolean NOT NULL DEFAULT true',
    );
    await queryRunner.query(
      'ALTER TABLE "language" ADD "active" boolean NOT NULL DEFAULT true',
    );
    await queryRunner.query(
      'ALTER TABLE "etymology_type" ADD "active" boolean NOT NULL DEFAULT true',
    );
    await queryRunner.query(
      'ALTER TABLE "etymology" ADD "active" boolean NOT NULL DEFAULT true',
    );
    await queryRunner.query(
      'ALTER TABLE "word" ADD "active" boolean NOT NULL DEFAULT true',
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "etymology_type" DROP COLUMN "active"',
    );
